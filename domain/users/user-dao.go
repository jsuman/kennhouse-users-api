...
import (
	...
	"github.com/jsuman/kennhouse-users-api/utils/cryptoUtils"
...
func (user *User) Get() *errors.RestErr {
	...
	stmt, err := usersdb.Client.Prepare("iselect d, first_name, last_name, email, date_created, status from users_db.users where id = ?;")
	if err != nil {
